...
### keras visualization
from keras.utils import plot_model
from show_loss_acc import *


################# import data set #################
# X_train_orig, Y_train_orig, X_test_orig, Y_test_orig, classes = load_dataset()
X_train_orig, Y_train_orig, X_test_orig, Y_test_orig = load_data("train_set_all.h5","train_set_all.h5")
...
happyModel = HappyModel((100,100,3))
...
# 3.train the model
    ...
    # 创建一个实例history,记录每次训练的loss和acc，用于画图，在fit中使用callbacks
    # 此处的 validation_data 是测试数据，按 epoch 测试
history = LossHistory()
