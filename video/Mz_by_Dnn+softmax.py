...
if __name__ == '__main__':
    ...
    train_x_orig, train_y, test_x_orig, test_y = load_data("train_set_all_flatten.h5","train_set_all_flatten.h5")
    index = 1
    ...
    layers_dims = [10000, 20, 7, 5, 1]  # 5-layer model
